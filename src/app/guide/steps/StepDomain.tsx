    ...
    <div className="space-y-6">
      ...
      {businessName && (
        <div className="bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-indigo-700 uppercase tracking-wide mb-0.5">Suggested domain</p>
            <p className="font-bold text-indigo-900 text-lg">{suggested}</p>
          </div>
        </div>
      )}
