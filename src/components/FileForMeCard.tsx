...
export default function FileForMeCard({ state, structure, businessName, companyId, userEmail }: Props) {
  ...
  return (
    <div className="rounded-xl border-2 border-indigo-200 bg-indigo-50/60 overflow-hidden">
      <div className="p-5">
        ...
        {!open && (
          <button
            ...
            className="mt-5 w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2"
          >
      ...
      {open && (
        <form onSubmit={handleSubmit} className="border-t border-indigo-200 bg-white p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2"
          >
